...
def idteman():
	...
	if i.upper() == 'Y':
		...
		return menu()
def menu():
	cetak("\n           !h.-.-..\n          /+/++//\n         /+/++//\n  !k*   !k* !h/+/++//\n   \ /  |/__//\n !h{!mX!h}v{!mX!h}!0!b|!cBFB!b|==========.\n   !h(!m'!h)!0  !h/'|'\           !b\\\n       !h/  \  \          !b'\n       !h\_  \_ \_   !k___!mIMU !cALI!k___\n\n !m* !bMULTI BRUTEFORCE FACEBOOK\n !m* !cAHMER\n !m* !phttps://github.com/ALIAHMER12\n !m* !phttps://facebook.com/SHADOWH44K3R\n !m* !phttps://ALITRIX.com\n!k.======================.\n|!h  GO GET !mID!h U WANT.....  !k|\n'======================'\n!k#!p1 OF FRIENDS \n!k#!p2 FROM GROUP\n!k#!p3 !mEXIT...")
